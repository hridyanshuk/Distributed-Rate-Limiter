...
const (
	RateLimiter_AllowRequest_FullMethodName = "/ratelimit.v1.RateLimiter/AllowRequest"
)
...
type RateLimiterClient interface {
	...
	AllowRequest(ctx context.Context, in *AllowRequestArgs, opts ...grpc.CallOption) (*AllowRequestResponse, error)
}
...
func (c *rateLimiterClient) AllowRequest(ctx context.Context, in *AllowRequestArgs, opts ...grpc.CallOption) (*AllowRequestResponse, error) {
...
type RateLimiterServer interface {
	// AllowRequest checks if a given client ID is allowed to make a request.
	AllowRequest(context.Context, *AllowRequestArgs) (*AllowRequestResponse, error)
...
func (UnimplementedRateLimiterServer) AllowRequest(context.Context, *AllowRequestArgs) (*AllowRequestResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AllowRequest not implemented")
}
...
func _RateLimiter_AllowRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RateLimiterServer).AllowRequest(ctx, req.(*AllowRequestArgs))
	}
...
var RateLimiter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/v1/ratelimit.proto",
}
